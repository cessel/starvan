	...
	<div class="row">
		<div class="col-xs-10">
			...
			<form class="form-horizontal" action="/index.php" method="post">
				<input type="hidden" name='installstep' value="step-2">
				...
				<div class="form-group">
					<label for="DB_PASSWORD" class="col-xs-4 control-label">Пароль пользователя</label>
					<div class="col-xs-6">
						<input type="text"  class="form-control"  name="DB_PASSWORD" id="DB_PASSWORD" value="" />
					</div>
				</div>
				<p class="text-right">
